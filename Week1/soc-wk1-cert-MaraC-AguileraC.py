...
days_32_timout = ((2**32)/1000/60/60/24)
days_64_timeout = ((2**64)/1000/60/60/24)
print("It would take: " + str(days_32_timout) + " days for a 32 bits system to tiout")

#How about a 64-bit system?
print("It would take: " + str(days_64_timeout) + " days for a 64 bits system to tiout")

#Calculate your age accurately based on your birthday 
now = datetime.now()
myBirthday = datetime(1993,6,30,12,15)
difference = now - myBirthday
print("My accurate birthday in seconds is : " + str(difference.total_seconds()))
'''
...
#Table of contents
print(("Chapter 1:".ljust(30,' '))+("Getting Started".center(30,' '))+("page 1".rjust(30,' ')))
print(("Chapter 2:".ljust(30,' '))+("Numbers".center(30,' '))+("page 9".rjust(30,' ')))
print(("Chapter 3:".ljust(30,' '))+ ("Letters".center(30,' '))+("page 13".rjust(30,' ')))
'''
...
def printTableOfContent(content,numberofchapters):
	for j in range(numberofchapters):
		print(content[j][0].ljust(30,' ') + ("page "+str(content[j][1])).rjust(30,' '))

printTableOfContent(book_info,number_of_chapters)
